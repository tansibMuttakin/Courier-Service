                ...
                <!-- <form action="{{route('order.store')}}" method="post">
                    ...
                    <div class="form-row flex">
                        <div class="col-5">
                            ...
                            <select id="merchant" name="merchant">
                                ...
                                @foreach($users as $user)
                                    @if($user->approved == 1)
                                        @if($user->name == $order->user->name)
                                        <option class="merchant" value="{{$user->id}}" selected>{{$user->name}}</option>
                                        @else
                        ...
                        <div class="col-2">
                            ...
                            <input type="text" placeholder="Merchand order id" name="merchant_order_id" value="{{$order->merchant_order_id}}">
                        </div>
                    </div>
                    <div class="form-row flex-space-between">
                        <div class="col-8">
                            ...
                            <div clas="row" style="display:flex; justify-content:space-between; margin-top: 50px;">
                                ...
                                <input type="text" name="recipient_name" placeholder="Recipient name" value="{{$order->recipient_name}}" required>
                                </div>
                                <div class="col-6">
                                    <label>Recipient Phone</label>
                                    <input type="text" name="recipient_phone" placeholder="Recipient phone" value="{{$order->recipient_phone}}" required>
                                </div>
                            </div>
                            <div class="row">
                                <label>Recipient Address</label>
                                <input type="text" name="recipient_address" placeholder="Recipient Address" value="{{$order->recipient_address}}" required>
                            ...
                            <div class="row flex-space-between">
                                <div class="col-6">
                                    ...
                                    <select id="city" name="recipient_city">
                                        @foreach($cities as $city)
                                            @if ($city->id == $order->recipient_city)
                                ...
                                <div class="col-6">
                                    ...
                                    <select id="zone" name="recipient_zone">
                                        ...
                                        @if ($zone->city_id == $order->recipient_city)
                                            @if ($zone->id == $order->recipient_zone)
                                ...
                                <div class="col-6">
                                    ...
                                    <select id="area" name="recipient_area">
                                        @foreach ($areas as $area)
                                            @if ($area->zone_id == $order->recipient_zone)
                                                @if ($area->id == $order->recipient_area)
                        ...
                        <div class="col-4">
                            ...
                            <div class="row flex-space-between">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="total_quantity" placeholder="Quantity" value="{{$order->deliveryInfo->quantity}}" required>
                                </div>
                            </div>
                            <div class="row">
                                <label for="amount">Amount To Collect</label>
                                <input name="amount_to_collect" id="amount" type="text" value="{{$order->deliveryInfo->cost_of_delivery}}" required>
                            </div>
                            <div class="row">
                                <label for="country">Special Instruction</label>
                                <input type="text" name="special_instruction" placeholder="Enter Special Instruction" value="{{$order->deliveryInfo->instruction}}">
                                <p><i>Only english character is allowed</i></p>
                            </div>
                            <div class="row">
                                <label for="country">Item Description & Item Price</label>
                                <input type="text" name="description_and_price" placeholder="Item Description & Item Price" value="{{$order->deliveryInfo->item_description_price}}">
                                <p><i>Only english character is allowed</i></p>
                            </div>
                        </div>
                    </div>
